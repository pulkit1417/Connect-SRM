...
const LoginForm = () => {
  ...
  const handleForgotPassword = async () => {
    if (!email) {
      displayNotification("Please enter your email address", "error");
      return;
    }
    ...
    try {
      ...
      displayNotification("Password reset email sent. Please check your inbox.", "success");
      setShowForgotPassword(false);
    } catch (error) {
      console.error("Error sending password reset email:", error);
      displayNotification("Failed to send password reset email. Please try again.", "error");
    }
  };
